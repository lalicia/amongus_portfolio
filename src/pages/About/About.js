    ...
    return (
        <div className="about-container">
            <div className="all-about">
                ...
                <h3 className="about-p">I don't know what to write here.  Whenever I have to say anything about myself I forget my entire life and wish the ground would open up and swallow me whole.<br></br><br></br>But thanks for stopping by - hope you're having a goodun.</h3>
